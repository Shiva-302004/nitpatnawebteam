...
const BelowSlider = () => {
    return (
        ...
        <div className='mt-9 bg-[#f2f2f2] lg:h-[30vh] '>
            <div className='flex '>
                <div className='mt-2 md:w-[58.33%] ml-4 md:mt-8 md:mb-8 lg:ml-32'>
                ...
                <div>
                    ...
                    <img src={layer2} className='absolute w-[15.625em] mt-[8.375em] -right-28 md:mt-6 md:ml-4 md:w-[200px] md:h-[200px] md:right-5 lg:right-16 z-10' alt="" />
                    <img src={layer3} className='absolute w-[15.625em] mt-[11.375em] -right-28 md:mt-16 md:ml-4 md:w-[200px] md:h-[200px] md:right-5 lg:right-16 z-5' alt="" />
                </div>
            </div>
        </div>
