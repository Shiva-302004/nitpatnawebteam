            ...
            <div className=''>
                ...
                <div className=' md:flex'>
                    <div className='w-[100vw]  bg-[#46c97e] mt-1 md:w-[50vw] h-[50vh] md:pb-5'>
                        <div className='ml-3 mr-3 sm:ml-16 md:ml-6 lg:ml-16 pt-6'data-aos="fade-up" data-aos-duration="2600"><span className=' font-bold text-xl'>US Patent </span><span className='font-serif'>No. 6,361,245B1</span></div>
                        <p className='ml-3 mr-3 sm:ml-16 sm:mr-16 md:ml-6 lg:ml-16 mt-1 md:text-md lg:text-lg text-lg font-serif font-thin opacity-50'data-aos="fade-up" data-aos-duration="2600">The product is resistant to tears, soft chemicals, puncture damage and ultraviolet light exposure. It’s also unaffected by hydrocarbons, mildew, rot and the freeze and thaw cycle.</p>
                        <ul className='ml-3 mr-3 sm:ml-16 md:ml-6 lg:ml-16 sm:mr-16 mt-1 flex justify-between' data-aos="fade-up" data-aos-duration="2600">
                    ...
                    <div className='bg-[#211321]'>

                    <div className='bg-[url(/src/assets/map.png)] w-[100vw] md:w-[50vw] h-[50vh]  object-fill bg-cover  md:mt-1' style={{objectFit:"cover"}} data-aos="fade-up">
                        <ul className=' ml-3 pt-6 flex' data-aos="fade-up" data-aos-duration="2600">
                            <li className=''>
                        ...
                        <div className='md:absolute' data-aos="fade-right" data-aos-duration="2600">
