...
const Designed = () => {
  return (
    <div className='mt-10 md:flex md:overflow-x-hidden h-[70vh]  md:h-[40vh] '>
        <h1 className='font-bold text-2xl ml-3 md:ml-6 lg:text-xl lg:ml-[10vw]'>Designed for You.</h1>
        <div className='relative mt-4 md:mt-2'>
            <ul className='list-disc ml-9 text-lg font-thin md:text-md md:list-[dash] md:ml-[5vw] lg:text-lg lg-ml-[10vw] xl:text-xl' >
        ...
        <div className='absolute mt-5  md:-right-32 lg:right-[8vw] lg:mt-10 '>
