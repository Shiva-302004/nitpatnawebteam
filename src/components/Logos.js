...
const Logos = () => {
    return (
        <div className='flex flex-col mt-1 lg:ml-[10vw] mb-3'>
            <div className='text-xl font-bold ml-4'>Over 1 million cars parked</div>
            <div className='text-xl font-thin ml-4 md:text-[grey]'>on Rollpark for companies like</div>
