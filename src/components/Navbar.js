...
const Navbar = () => {
  ...
  return (
    <div >
      ...
      <div className={`${navbar ? "bg-transparent" : "bg-white"} fixed w-[100vw] h-[6vh] p-2 top-0 left-0  flex z-10 md:z-40`} style={{ borderBottom: "1px solid white" }}>
      ...
      <div className={`bg-[#2EBD71] absolute top-0 w-[100%] h-[100%] z-40 ${menu ? "left-[-100%]" : "left-0"}  md:left-0 md:bg-transparent md:fixed md:top-0`} style={{ transition: "ease-in 0.2s" }}>
