...
const Hero = () => {
    ...
    return (
        <div className={`bg-white ${!click?"h-[100vh] overflow-y-hidden":""}`}>
            <video className={`w-[100vw] absolute  bg-cover  object-cover  ${click?" top-0 left-0 h-[100vh] z-50 fixed ":" h-[90vh] "} hii `} ref={videoref} poster={poster} autoPlay loop   >
            ...
            <div className='absolute mt-[9vh] w-[100vw] overflow-x-hidden md:h-[fit-content] '>
                <Stats></Stats>
                <Designed></Designed>
                <Logos></Logos>
                <Gallery></Gallery>
