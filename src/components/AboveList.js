        ...
        <>
            ...
            <div className='flex '>
                <div className='mt-2 md:w-[58.33%] ml-4 md:mt-8 md:mb-8 lg:ml-32'>
                    ...
                    <Link className='w-[9.31818em] md:w-[100%] flex mt-3 mb-4'><span className='text-[16px] font-bold'>Installation process</span> <MdArrowRightAlt className='ml-2 mt-1'></MdArrowRightAlt></Link>
                </div>
                <div>
